...
const VolumeOff: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
...
const VolumeLow: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
...
const VolumeMedium: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
...
const VolumeHigh: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
...
const Volume: React.FC<IconProps> = ({ percent = 100, ...props }) => {
  if (percent === 0) return <VolumeOff {...props} />;
  if (percent <= 0.2) return <VolumeLow {...props} />;
  if (percent <= 0.4) return <VolumeMedium {...props} />;
  return <VolumeHigh {...props} />;
};
