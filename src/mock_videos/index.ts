...
export const request: IMovies[] = [
  ...
  },
  {
    ...
    movies: [
      {
        id: "663a9f14-f537-48e0-b899-652a4f9e7f93",
        position: 1,
        title: "Создание кошелька Movve",
        mimeType: "video/mp4",
        url: "/videos/663a9f14-f537-48e0-b899-652a4f9e7f93.mp4",
        thumbnail: "/thumbnails/663a9f14-f537-48e0-b899-652a4f9e7f93.png",
        description:
          "Это видео показывает, как создать кошелек Movve, включая загрузку приложения, настройку пароля, резервное копирование 12 слов безопасности и советы по их безопасному хранению.",
      },
      {
        id: "c10d71f7-1655-448b-8bfa-9aa3ec867765",
        position: 2,
        title: "Доступ к вашему кошельку",
        mimeType: "video/mp4",
        url: "/videos/c10d71f7-1655-448b-8bfa-9aa3ec867765.mp4",
        thumbnail: "/thumbnails/c10d71f7-1655-448b-8bfa-9aa3ec867765.png",
        description:
          "После создания и сохранения ваших 12 слов безопасности войдите в главный экран кошелька, нажмите 'Discover', введите URL и создайте свою учетную запись в системе Move.",
      },
      {
        id: "8e8cb8de-7f34-487e-9cf9-27f9de2713b0",
        position: 3,
        title: "Активация ваших инвестиций",
        mimeType: "video/mp4",
        url: "/videos/8e8cb8de-7f34-487e-9cf9-27f9de2713b0.mp4",
        thumbnail: "/thumbnails/8e8cb8de-7f34-487e-9cf9-27f9de2713b0.png",
        description:
          "Чтобы осуществить платеж, скопируйте адрес кошелька, откройте приложение, перейдите в 'Активы', выберите USDT в сети TRON-TRC20, вставьте адрес и завершите платеж в USDT.",
      },
      {
        id: "0792716a-6cd1-4aaa-b8cf-74c511ba6fc9",
        position: 4,
        title: "Вывод средств",
        mimeType: "video/mp4",
        url: "/videos/0792716a-6cd1-4aaa-b8cf-74c511ba6fc9.mp4",
        thumbnail: "/thumbnails/0792716a-6cd1-4aaa-b8cf-74c511ba6fc9.png",
        description:
          "Это видео шаг за шагом объясняет, как выводить заработок после получения бонусов: через меню перейдите в 'Мой аккаунт', выберите 'Вывод', введите сумму и подтвердите транзакцию.",
      },
      {
        id: "6c589a10-a28c-4c2b-8577-36f188294c64",
        position: 5,
        mimeType: "video/mp4",
        url: "/videos/6c589a10-a28c-4c2b-8577-36f188294c64.mp4",
        thumbnail: "/thumbnails/6c589a10-a28c-4c2b-8577-36f188294c64.png",
        title: "Активация бинарного счета",
        description:
          "Это видео объясняет, как активировать бинарный счет: выберите сторону, создайте кошельки, инвестируйте по $100 в каждую сторону и разблокируйте бонусы, чтобы начать эффективно работать.",
      },
      {
        id: "92403ac1-174f-48cb-8588-c6738924c256",
        position: 6,
        mimeType: "video/mp4",
        url: "/videos/92403ac1-174f-48cb-8588-c6738924c256.mp4",
        thumbnail: "/thumbnails/92403ac1-174f-48cb-8588-c6738924c256.png",
        title: "Обновление инвестиционного счета",
        description:
          "Это видео объясняет, как обновить инвестиционный счет: добавление средств, выбор опции обновления, оплата необходимой суммы и автоматическое увеличение баланса счета.",
      },
      {
        id: "ad59acb3-3436-4655-b38b-9f05096a8372",
        position: 7,
        mimeType: "video/mp4",
        url: "/videos/ad59acb3-3436-4655-b38b-9f05096a8372.mp4",
        thumbnail: "/thumbnails/ad59acb3-3436-4655-b38b-9f05096a8372.png",
        title: "Обзор бинарной системы",
        description:
          "Это видео объясняет, как бинарная система отслеживает активность пользователя, балансирует стороны, распределяет ежедневные бонусы и подчеркивает важность обновления счетов до истечения срока для максимизации потенциального заработка.",
      },
    ],
  },
];
